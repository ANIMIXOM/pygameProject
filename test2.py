...
class Player(pygame.sprite.Sprite):
    def __init__(self, pos, group):
        ...
        self.image = pygame.image.load("datafiles/evil1.png").convert_alpha()
...
class CameraGroup(pygame.sprite.Group):
    def __init__(self):
        ...
        # ground
        self.ground_surf = pygame.image.load("datafiles/ground.png").convert_alpha()
    ...
    def mouse_control(self):
        ...
        bottom_border = (
            self.display_surface.get_size()[1] - self.camera_borders["bottom"]
        )
        ...
        if top_border < mouse.y < bottom_border:
            ...
            if mouse.x < left_border:
                mouse_offset_vector = mouse - pygame.math.Vector2(
