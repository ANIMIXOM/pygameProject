...
class gui():
    ...
    def update(self):
        ...
        self.text_surface = self.text_surface = self.font.render(str(pl.hp), True, (255, 255, 255))
...
inventory = {"fire_cristal": 2, "el_cristal": 2, "healme5": 3, "healme20": 10, "healme100": 1,
             "wearpon": 0, "rupis": 0}
